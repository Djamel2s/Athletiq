...
export const useWorkoutStore = defineStore('workout', {
  ...
  actions: {
    ...
    async updateExercise(workoutId: number, exerciseId: number, data: Partial<Exercise>) {
      try {
        const api = useWorkoutApi();
    ...
    async updateSet(workoutId: number, exerciseId: number, setId: number, data: Partial<Set>) {
      try {
        const api = useWorkoutApi();
