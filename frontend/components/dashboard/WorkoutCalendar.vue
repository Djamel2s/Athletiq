  ...
  <div class="card-glass">
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <div class="flex items-center gap-2">
        ...
        <span
          class="text-sm md:text-base font-semibold text-primary-800 dark:text-primary-200 min-w-[120px] md:min-w-[140px] text-center capitalize"
        >
          {{ monthLabel }}
        </span>
        <button
    ...
    <div class="grid grid-cols-7 gap-0.5 md:gap-1">
      <button
        ...
        :class="[
          ...
          cell.isToday && !isSelected(cell) ? 'ring-2 ring-sand-500 dark:ring-sand-600' : '',
          isSelected(cell)
      ...
      <div v-if="selectedWorkouts.length > 0" class="mt-4 space-y-3">
        ...
        >
          <div class="flex items-center gap-3 min-w-0">
            <div
              class="w-9 h-9 bg-gradient-to-br from-sand-500 to-sand-600 rounded-lg flex items-center justify-center flex-shrink-0"
            >
            ...
            <div class="min-w-0">
              <p
                class="font-semibold text-primary-900 dark:text-primary-100 text-xs md:text-sm truncate"
              >
                {{ workout.name }}
              </p>
          ...
          <div class="text-right flex-shrink-0 ml-2">
            <p
              ...
              class="text-xs md:text-sm font-medium text-primary-800 dark:text-primary-200"
            >
