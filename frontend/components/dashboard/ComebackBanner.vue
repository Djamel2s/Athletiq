<template>
  <Transition name="fade-slide">
    ...
    >
      ...
      <div class="absolute inset-0 rounded-2xl bg-gradient-to-br from-[#d4c4b0]/20 to-[#b8a48f]/20 pointer-events-none"></div>
      ...
      <div class="relative flex flex-col sm:flex-row items-start gap-4">
        <!-- Icon -->
        <div class="w-12 h-12 bg-gradient-to-br from-[#d4c4b0] to-[#b8a48f] rounded-xl flex items-center justify-center flex-shrink-0 shadow-sm">
