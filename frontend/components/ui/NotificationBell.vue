  ...
  <div class="relative">
    ...
    <Transition name="dropdown">
      ...
      >
        <!-- Header -->
        <div
          class="flex items-center justify-between p-4 border-b border-primary-200 dark:border-primary-700"
        >
          ...
          >
            <div class="flex items-start gap-3">
              ...
              >
                ...
                <svg
                  v-else-if="notif.type === 'STREAK_MILESTONE'"
                  class="w-4 h-4"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <svg
                  v-else-if="notif.type === 'GOAL_ACHIEVED'"
                  class="w-4 h-4"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div class="flex-1 min-w-0">
                ...
                <p
                  v-if="notif.message"
                  class="text-xs text-primary-500 dark:text-primary-400 mt-0.5 line-clamp-2"
                >
                  {{ notif.message }}
                </p>
