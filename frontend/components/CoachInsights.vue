  ...
  <Transition name="fade-slide">
    ...
    <div v-if="loading" class="card-glass !p-4 space-y-3">
      ...
      <div
        v-for="i in 2"
        :key="i"
        class="rounded-xl bg-primary-100 dark:bg-primary-800/50 p-3 space-y-2 animate-pulse"
      >
    ...
    <div v-else-if="insights.length > 0" class="card-glass !p-4">
      ...
      <div class="flex items-center gap-2 mb-3">
        <div
          class="w-8 h-8 bg-gradient-to-br from-violet-500 to-indigo-600 rounded-lg flex items-center justify-center flex-shrink-0 shadow-sm"
        >
