<template>
  <div class="relative">
    <!-- Photo Display -->
    <div
      class="relative aspect-[3/4] bg-primary-100 dark:bg-primary-800 rounded-2xl overflow-hidden"
    >
      <img
      ...
      <div
        v-if="photos.length > 0"
        class="absolute top-4 left-4 px-3 py-1.5 bg-black/50 backdrop-blur-sm rounded-xl text-white text-sm font-medium"
      >
      ...
      <div
        ...
        class="absolute top-4 right-4 px-3 py-1.5 bg-black/50 backdrop-blur-sm rounded-xl text-white text-sm font-medium"
      >
    ...
    <div v-if="photos.length > 1" class="mt-4 space-y-3">
      ...
      <div class="flex items-center justify-center space-x-4">
        ...
        <!-- Speed Control -->
        <select v-model="speed" class="input-primary !w-auto !py-2 !px-3 text-sm">
    ...
    recorder.onstop = async () => {
      ...
      try {
        ...
        try {
          ...
          const storyRes = await shareToStory({
            url: publicUrl,
