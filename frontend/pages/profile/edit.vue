    ...
    <div class="pt-24 md:pt-32 px-4 md:px-6 pb-8 md:pb-12">
      <div class="w-full max-w-lg mx-auto">
        ...
        <div class="card-glass slide-up">
          <form @submit.prevent="handleSave" class="space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label for="firstName" class="block text-sm font-medium text-primary-700 dark:text-primary-300 mb-1.5">Prenom</label>
                <input id="firstName" v-model="firstName" type="text" autocomplete="given-name" class="input-primary" placeholder="Jean" />
              </div>
              <div>
                <label for="lastName" class="block text-sm font-medium text-primary-700 dark:text-primary-300 mb-1.5">Nom</label>
                <input id="lastName" v-model="lastName" type="text" autocomplete="family-name" class="input-primary" placeholder="Dupont" />
              </div>
            </div>

            <!-- Email (lecture seule) -->
            <div>
              <label for="email" class="block text-sm font-medium text-primary-700 dark:text-primary-300 mb-1.5">Email</label>
              <input id="email" :value="authStore.user?.email" type="email" disabled class="input-primary opacity-60 cursor-not-allowed" />
            </div>

            <!-- Genre -->
            <div>
              <label class="block text-sm font-medium text-primary-700 dark:text-primary-300 mb-3">Genre</label>
            ...
            <!-- Objectif -->
            <div>
              <label class="block text-sm font-medium text-primary-700 dark:text-primary-300 mb-3">Objectif d'entrainement</label>
              <div class="grid grid-cols-2 gap-2 md:gap-3">
                <button
            ...
            <!-- Submit button -->
            <button type="submit" :disabled="loading" class="btn-primary w-full text-base md:text-lg py-3 md:py-4">
        ...
        <div class="text-center mt-6">
          <NuxtLink to="/profile" class="text-sm text-primary-600 dark:text-primary-400 hover:text-primary-900 dark:hover:text-primary-100 transition-colors inline-flex items-center gap-2">
