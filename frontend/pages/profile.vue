    ...
    <div class="w-full max-w-lg mx-auto">
      ...
      <div class="flex flex-col items-center mb-6 md:mb-8 fade-in">
        <div class="relative group">
          <div class="w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden bg-gradient-primary flex items-center justify-center shadow-lg">
          ...
          <label class="absolute inset-0 flex items-center justify-center bg-black/0 group-hover:bg-black/40 rounded-full cursor-pointer transition-colors">
