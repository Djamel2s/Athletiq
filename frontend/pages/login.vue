  ...
  <div class="min-h-screen flex items-center justify-center px-6 py-12 geometric-bg">
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-10 fade-in">
        ...
        <h1 class="text-4xl font-bold text-primary-900 mb-2 text-display">Connexion</h1>
        <p class="text-primary-600 text-body-relaxed">Connectez-vous à votre compte</p>
      </div>
      ...
      <div class="card-glass slide-up">
        ...
        <div class="mt-8 pt-6 border-t border-sand-200 text-center">
          <p class="text-primary-600">
            ...
            <NuxtLink to="/register" class="font-medium text-sand-600 hover:text-sand-800 transition-colors">
              S'inscrire
            </NuxtLink>
          </p>
        </div>
