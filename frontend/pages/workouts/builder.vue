  ...
  <div class="min-h-screen">
    ...
    <div class="px-4 md:px-6 pb-20 max-w-5xl mx-auto">
      ...
      <div class="flex items-center justify-between mb-8 fade-in">
        <h1
          class="text-3xl md:text-5xl lg:text-6xl font-bold text-display bg-gradient-to-r from-sand-500 to-primary-900 dark:to-primary-100 bg-clip-text text-transparent"
        >
          Préparer un Workout
        </h1>
          ...
          <div v-else class="space-y-4">
            ...
            >
              <div class="flex items-stretch">
                <div
                  class="w-12 bg-gradient-primary flex items-center justify-center flex-shrink-0"
                >
                ...
                <div class="flex-1 p-4">
                  <div class="flex items-start justify-between mb-3">
                    <div class="flex-1">
                      <h3
                        class="text-base md:text-lg font-bold text-primary-900 dark:text-primary-100 mb-1"
                      >
                  ...
                  <div class="space-y-2">
                    ...
                    >
                      ...
                      <span
                        class="text-xs text-primary-500 dark:text-primary-400 font-medium w-12 flex-shrink-0"
                        >Série {{ Number(setIndex) + 1 }}</span
                      >
                      <input
                      ...
                      <span class="text-[10px] text-primary-300 dark:text-primary-600 mx-0.5"
                        >|</span
                      >
                      <input
    ...
    >
      <div
        class="bg-white dark:bg-primary-900 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden mx-2 md:mx-0"
      >
        <div class="p-4 md:p-6 border-b border-primary-200 dark:border-primary-700">
          <div class="flex items-center justify-between mb-4">
            <h2 class="text-xl md:text-2xl font-bold text-primary-900 dark:text-primary-100">
          ...
          <div class="space-y-4">
            ...
            <div class="flex flex-col sm:flex-row sm:flex-wrap gap-2">
              <select
                ...
                class="input-primary w-full sm:w-auto"
              >
          ...
          <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <ExerciseAnimation
                ...
                class="mb-3"
              />
              <h3 class="font-bold text-primary-900 dark:text-primary-100 mb-2">
                {{ exercise.name }}
              </h3>
              <p class="text-sm text-primary-600 dark:text-primary-400 mb-3 line-clamp-2">
    ...
    <Teleport to="body">
      <div v-if="showSavedModal" class="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        ></div>
        <div
          class="relative bg-white dark:bg-primary-900 rounded-2xl p-6 md:p-8 max-w-md w-full shadow-2xl border border-primary-200 dark:border-primary-700 text-center"
        >
          <div
          ...
          <p class="text-primary-600 dark:text-primary-400 mb-6">
            Votre entraînement est prêt. Vous voulez le lancer maintenant ?
          </p>
          <div class="flex flex-col sm:flex-row gap-3">
            <button
              @click="navigateTo('/workouts')"
              class="flex-1 px-4 py-3 rounded-xl border border-primary-300 dark:border-primary-600 text-primary-700 dark:text-primary-300 font-semibold hover:bg-primary-100 dark:hover:bg-primary-800 transition-colors"
            >
              Plus tard
            </button>
            <button
              @click="navigateTo(`/workouts/${workoutId}/live`)"
