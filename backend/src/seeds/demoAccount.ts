...
export async function seedDemoAccount() {
  ...
  console.log(
    `  Created ${workoutCount} workouts (total volume: ${Math.round(totalVolume / 1000)}t)`
  );
  ...
  const notifications = [
    {
      ...
      message: 'Développé couché : 100kg - Bravo !',
      daysAgo: 12,
    },
    {
      type: NotificationType.STREAK_MILESTONE,
      title: 'Série de 4 semaines !',
      message: 'Vous vous entraînez depuis 4 semaines consécutives.',
      daysAgo: 28,
    },
    {
      type: NotificationType.STREAK_MILESTONE,
      title: 'Série de 8 semaines !',
      message: '8 semaines de suite, impressionnant !',
      daysAgo: 5,
    },
    {
      type: NotificationType.GOAL_ACHIEVED,
      title: 'Objectif atteint !',
      message: 'Développé couché 100kg - Objectif accompli !',
      daysAgo: 12,
    },
    {
      type: NotificationType.GOAL_PROGRESS,
      title: 'Progression Squat',
      message: 'Vous êtes à 85% de votre objectif Squat 140kg',
      daysAgo: 3,
    },
    {
      type: NotificationType.PR_ACHIEVED,
    ...
    },
    {
      type: NotificationType.PR_ACHIEVED,
      title: 'Nouveau record !',
      message: 'Soulevé de terre : 130kg',
      daysAgo: 15,
    },
  ];
