...
async function seed() {
  ...
  const exerciseData = [
    // Chest
    { name: 'Développé couché', primaryMuscle: MuscleGroup.CHEST, muscleGroups: [MuscleGroup.CHEST, MuscleGroup.TRICEPS, MuscleGroup.SHOULDERS], equipment: Equipment.BARBELL, difficulty: Difficulty.INTERMEDIATE },
    { name: 'Développé incliné haltères', primaryMuscle: MuscleGroup.CHEST, muscleGroups: [MuscleGroup.CHEST, MuscleGroup.SHOULDERS], equipment: Equipment.DUMBBELL, difficulty: Difficulty.INTERMEDIATE },
    { name: 'Écarté poulie vis-à-vis', primaryMuscle: MuscleGroup.CHEST, muscleGroups: [MuscleGroup.CHEST], equipment: Equipment.CABLE, difficulty: Difficulty.BEGINNER },
    ...
    { name: 'Rowing haltère unilatéral', primaryMuscle: MuscleGroup.BACK, muscleGroups: [MuscleGroup.BACK], equipment: Equipment.DUMBBELL, difficulty: Difficulty.BEGINNER },
    { name: 'Soulevé de terre', primaryMuscle: MuscleGroup.BACK, muscleGroups: [MuscleGroup.BACK, MuscleGroup.HAMSTRINGS, MuscleGroup.GLUTES], equipment: Equipment.BARBELL, difficulty: Difficulty.ADVANCED },
    // Shoulders
    { name: 'Développé militaire', primaryMuscle: MuscleGroup.SHOULDERS, muscleGroups: [MuscleGroup.SHOULDERS, MuscleGroup.TRICEPS], equipment: Equipment.BARBELL, difficulty: Difficulty.INTERMEDIATE },
    { name: 'Élévations latérales', primaryMuscle: MuscleGroup.SHOULDERS, muscleGroups: [MuscleGroup.SHOULDERS], equipment: Equipment.DUMBBELL, difficulty: Difficulty.BEGINNER },
    { name: 'Oiseau haltères', primaryMuscle: MuscleGroup.SHOULDERS, muscleGroups: [MuscleGroup.SHOULDERS, MuscleGroup.BACK], equipment: Equipment.DUMBBELL, difficulty: Difficulty.BEGINNER },
    ...
    { name: 'Curl haltères alternés', primaryMuscle: MuscleGroup.BICEPS, muscleGroups: [MuscleGroup.BICEPS], equipment: Equipment.DUMBBELL, difficulty: Difficulty.BEGINNER },
    ...
    { name: 'Presse à cuisses', primaryMuscle: MuscleGroup.QUADS, muscleGroups: [MuscleGroup.QUADS, MuscleGroup.GLUTES], equipment: Equipment.MACHINE, difficulty: Difficulty.BEGINNER },
    { name: 'Fentes haltères', primaryMuscle: MuscleGroup.QUADS, muscleGroups: [MuscleGroup.QUADS, MuscleGroup.GLUTES], equipment: Equipment.DUMBBELL, difficulty: Difficulty.INTERMEDIATE },
    ...
    { name: 'Relevé de jambes suspendu', primaryMuscle: MuscleGroup.ABS, muscleGroups: [MuscleGroup.ABS], equipment: Equipment.BODYWEIGHT, difficulty: Difficulty.INTERMEDIATE },
  ]
  ...
  const routines = {
    push: {
      ...
      exercises: [
        { lib: 'Développé couché', sets: [{ w: 80, r: 10 }, { w: 85, r: 8 }, { w: 90, r: 6 }, { w: 85, r: 8 }] },
        { lib: 'Développé incliné haltères', sets: [{ w: 30, r: 12 }, { w: 32, r: 10 }, { w: 34, r: 8 }] },
        { lib: 'Écarté poulie vis-à-vis', sets: [{ w: 15, r: 15 }, { w: 17, r: 12 }, { w: 17, r: 12 }] },
        { lib: 'Développé militaire', sets: [{ w: 40, r: 10 }, { w: 45, r: 8 }, { w: 45, r: 8 }] },
        { lib: 'Élévations latérales', sets: [{ w: 10, r: 15 }, { w: 12, r: 12 }, { w: 12, r: 12 }] },
    ...
    pull: {
      ...
      exercises: [
        ...
        { lib: 'Rowing haltère unilatéral', sets: [{ w: 28, r: 12 }, { w: 30, r: 10 }, { w: 30, r: 10 }] },
        { lib: 'Face pull', sets: [{ w: 20, r: 15 }, { w: 22, r: 15 }, { w: 22, r: 12 }] },
        { lib: 'Curl barre', sets: [{ w: 30, r: 12 }, { w: 32, r: 10 }, { w: 35, r: 8 }] },
        { lib: 'Curl haltères alternés', sets: [{ w: 12, r: 12 }, { w: 14, r: 10 }, { w: 14, r: 10 }] },
      ],
    },
    legs: {
      ...
      exercises: [
        ...
        { lib: 'Presse à cuisses', sets: [{ w: 180, r: 12 }, { w: 200, r: 10 }, { w: 220, r: 8 }] },
        { lib: 'Fentes haltères', sets: [{ w: 16, r: 12 }, { w: 18, r: 10 }, { w: 18, r: 10 }] },
    ...
    upperBody: {
      ...
      exercises: [
        { lib: 'Développé couché', sets: [{ w: 82, r: 8 }, { w: 85, r: 6 }, { w: 82, r: 8 }] },
        { lib: 'Tractions', sets: [{ w: 0, r: 10 }, { w: 0, r: 8 }, { w: 0, r: 8 }] },
        { lib: 'Développé militaire', sets: [{ w: 42, r: 10 }, { w: 45, r: 8 }, { w: 42, r: 10 }] },
        { lib: 'Rowing barre', sets: [{ w: 72, r: 10 }, { w: 75, r: 8 }, { w: 72, r: 10 }] },
        { lib: 'Dips', sets: [{ w: 0, r: 12 }, { w: 0, r: 10 }, { w: 0, r: 10 }] },
        { lib: 'Curl haltères alternés', sets: [{ w: 14, r: 12 }, { w: 14, r: 10 }] },
      ],
    },
  }
